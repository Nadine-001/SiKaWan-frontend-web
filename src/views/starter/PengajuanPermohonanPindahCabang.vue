    ...
    <div class="row">
      <div class="col-md-12">
        <h1 style="color: #006d32">
          Formulir Pengajuan Surat Permohonan Pindah Cabang
        </h1>
        ...
        <div class="row">
          <div class="col-md-12 space-y-5">
            ...
            >
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <input
                    ...
                    id="licence_type"
                    placeholder=""
                    value="Permohonan Pindah Cabang"
                    style="border: 2px solid #9197b3"
                  />
                </div>
              </div>
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Unggah kwitansi lunas pembayaran iuran anggota</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Surat Keterangan Bekerja dari pimpinan sarana kesehatan yang
                  akan dituju</label
                >
                <div class="col-sm-8">
                  <input
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Surat Permohonan Pindah Anggota</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Surat Keterangan Domisili</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
