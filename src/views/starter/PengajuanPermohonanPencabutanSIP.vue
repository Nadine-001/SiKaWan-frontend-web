    ...
    <div class="row">
      <div class="col-md-12">
        <h1 style="color: #006d32">
          Formulir Pengajuan Permohonan Pencabutan SIP-RO
        </h1>
            ...
            >
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Unggah Surat Permohonan Rekomendasi Mencabut SIP-RO</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Unggah Surat Pernyataan Mencabut SIP-RO</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
