    ...
    <div class="row">
      <div class="col-md-12">
        <h1 style="color: #006d32">
          Formulir Pengajuan Surat Izin Praktik Refraksionis Optisi
        </h1>
            ...
            >
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Unggah Kwitansi Biaya Administrasi (Rp.50.000,00)</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Surat Pengantar dari Pengcab</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Surat Pernyataan Patuh Etika Profesi</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Kwitansi Lunas Iuran Anggota minimal dalam Masa Period STR
                  atau Bukti Transfer Iuran PENGDA.</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
