...
<template>
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <h1 style="color: #006d32">Formulir Pengajuan Rekomendasi BPJS</h1>
            ...
            >
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Unggah Kwitansi Biaya Administrasi (Rp.35.000,00)</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
              ...
              <div class="row">
                <label class="col-sm-4 col-form-label" for="files"
                  >Surat Permohonan Bekerjasama dengan BPJS</label
                >
                <div class="col-sm-8">
                  <input
                    class="form-control"
